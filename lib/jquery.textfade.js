...
(function() {
  ...
  TextFade = function($element, action, options) {
    var $, BLANK_TEXT_REGEX, LINES_SPLIT_REGEX, SEQUENCES, blankText, capitalize, defaultOptions, flatten, max, sequenceClone, shuffle, text, textToSequences, times, zip, _ref;
    ...
    this._step = function(sequence) {
      return times(this.options.threads, (function(_this) {
        return function() {
    ...
    })(this), this.options.milliseconds);
    return this;
  };
