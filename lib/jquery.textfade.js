...
(function() {
  ...
  TextFade = function($element, action, options) {
    var $, BLANK_TEXT_REGEX, LINES_SPLIT_REGEX, SEQUENCES, blankText, capitalize, defaultSettings, flatten, max, sequenceClone, shuffle, text, textToSequences, times, zip, _base;
    ...
    SEQUENCES = {
      ...
      'rtl_ttb': function(text) {
        return flatten(textToSequences(text, function(lineSequence, charIndex) {
