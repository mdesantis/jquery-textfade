...
(function() {
  ...
  TextFade = function($element, action, options) {
    var BLANK_REPLACE_REGEX, LINES_SPLIT_REGEX, SEQUENCES, blankText, capitalize, defaultSettings, sequenceClone, shuffle, text, times, _base,
      _this = this;
    ...
    SEQUENCES = {
      ...
      'ltr_btt': function(text) {
        var c, i, line, lines, seq, seqi, _i, _len;
        seq = [];
        c = 0;
